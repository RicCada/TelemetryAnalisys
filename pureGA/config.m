...
lonLP = 14.0543613; 
latLP = 41.8086205;  % LaunchPad data
zLP = 1414; 

wgs84 = wgs84Ellipsoid;
[north,east,down] = geodetic2ned(latApo, lonApo, zApo, latLP,lonLP , zLP,wgs84);


expectedTarget = [north, east, zApo];   %expected target in NED-axis
